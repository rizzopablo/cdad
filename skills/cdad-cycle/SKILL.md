...
Modelos del diseño (perfil optimus). Perfiles: economical (flash) / premium (top-tier configurable vía env CDAD_PREMIUM_MODEL_*). Switch: install.sh --economical|--premium.
