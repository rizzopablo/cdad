...
Cargá el skill `cdad-cycle`. Cargá `code-review` (metodología) y `code-philosophy` (chequeos de filosofía). Cargá el skill `odoo-reviewer` para el checklist OCA + listado pylint-odoo vigente + split mandatory/advisory.
